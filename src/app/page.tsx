...
import { db, Sale, SaleItem, CultivationLog, InputInventory, HarvestLog, PlantingLog } from '@/lib/db';
...
export default function DashboardPage() {
  ...
  const [totalInputCosts, setTotalInputCosts] = useState<number>(0);
  ...
  const fetchData = useCallback(async (startDate?: string | null, endDate?: string | null) => {
    ...
    try {
      ...
      setTotalInputCosts(periodInputCosts);

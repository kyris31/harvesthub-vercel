...
export default function PlantingLogForm({ initialData, onSubmit, onCancel, isSubmitting }: PlantingLogFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
        ...
        console.error("Error during stock update or planting log submission:", error);
        setFormError("An error occurred while saving. Stock might not have been updated if planting log failed.");
